...
##[ MQTT Raspberry Pi  SparkPlugB Implementations ]###########################
...
## serverUrl = "localhost"
serverUrl = "192.168.1.4"
## "spBv1.0/myGroupId/NCMD/myNodeName/#"

##12-March-2023 myGroupId = "Sparkplug B Devices"
##12-March-2023 myNodeName = "Python Edge Node 1"

# ################# Sparkplug B Devices Details ###############
...
def on_connect(client, userdata, flags, rc):
    ...
    ##12-March-2023 client.subscribe("spBv1.0/" + myGroupId + "/NCMD/" + myNodeName + "/#")
    ##12-March-2023 client.subscribe("spBv1.0/" + myGroupId + "/DCMD/" + myNodeName + "/#")
    client.subscribe("spBv1.0/myGroupId/NCMD/myNodeName/#")
    client.subscribe("spBv1.0/myGroupId/DCMD/myNodeName/#")
    client.subscribe("spBv1.0/myGroupId/NCMD/myNodeName/#")
    client.subscribe("test")
    ## 11-march-2023 client.subscribe("spBv1.0")
    client.subscribe("spBv1.0/Sparkplug B Devices/NCMD/Python Edge Node 1")
    client.subscribe("spBv1.0/myGroupId/NCMD/myNodeName")
    client.subscribe("spBv1.0/myGroupId/DCMD/myNodeName")
...
def on_message(client, userdata, msg):
    ...
    if tokens[0] == "spBv1.0" and tokens[1] == myGroupId and (tokens[2] == "NCMD" or tokens[2] == "DCMD") and tokens[3] == myNodeName:
        ...
        print("MQTTSparkPlugBService received Patient data is :")
        print(str(msg.payload.decode("utf-8")))  # printing Received message
        print("..................................");
    print("Done publishing")
    client.subscribe("test")  # subscribe topic test
    ## 11-march-2023 client.subscribe("spBv1.0")  # subscribe topic test
######################################################################
...
# Main Application
######################################################################
print("[ Starting MQTTSparkPlugBService application ]")
...
##12-March-2023  client= paho.Client("user") #create client object
client.on_connect = on_connect
client.on_message = on_message
##12-March-2023  client.username_pw_set(myUsername, myPassword)
client.username_pw_set(myUsername, myPassword)
deathByteArray = bytearray(deathPayload.SerializeToString())
##12-March-2023 client.will_set("spBv1.0/" + myGroupId + "/NDEATH/" + myNodeName, deathByteArray, 0, False)
client.will_set("spBv1.0/" + myGroupId + "/NDEATH/" + myNodeName, deathByteArray, 0, False)
client.connect(serverUrl, 1883, 60)
## 12-March-2023 client.connect(broker,port)#connection establishment with broker
